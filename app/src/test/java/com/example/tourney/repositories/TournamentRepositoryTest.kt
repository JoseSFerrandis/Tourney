...
class TournamentRepositoryTest {
    ...
    fun testAddTournamentAvoidsDuplicates() {
        ...
        repository.addTournament(t1Duplicate)
    ...
    fun testUpdateTournamentInList() {
        ...
        repository.addTournament(original)
    ...
    @Test
    fun testClear() {
        repository.addTournament(Tournament(10L, "T10", "G10", 100L, "Admin", mutableListOf(), 16, null, null, null, 1010))
